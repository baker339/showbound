...
Revision ID: 0e5a79eba7e9
Revises: dc9aadaad5a6
Create Date: 2025-07-03 12:15:39.991389
...
revision: str = '0e5a79eba7e9'
down_revision: Union[str, Sequence[str], None] = 'dc9aadaad5a6'
...
def downgrade() -> None:
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('atbats_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.ForeignKeyConstraint(['batter_id'], ['players.id'], name='atbats_batter_id_fkey'),
    sa.ForeignKeyConstraint(['game_id'], ['games.id'], name='atbats_game_id_fkey'),
    sa.ForeignKeyConstraint(['pitcher_id'], ['players.id'], name='atbats_pitcher_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='atbats_pkey'),
    ...
    sa.Column('source_url', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['player_id'], ['players.id'], name=op.f('stat_tables_player_id_fkey')),
    sa.PrimaryKeyConstraint('id', name=op.f('stat_tables_pkey'))
    )
